...
#define PanhandlerTrigger       100                 // Number (integer) of events needed for ratings reminder alert
#define PanhandlerRetrigger     100                 // Number (integer) of events needed to retrigger ratings reminder alert
